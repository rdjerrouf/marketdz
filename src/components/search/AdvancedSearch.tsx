        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-40 p-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="flex-1 px-3 py-2 bg-blue-500 text-white rounded-md hover:bg-[#A16207] transition-colors"
              >
                Appliquer
              </button>
            </div>
            ...
            {error ? (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-[#A16207] transition-colors"
                >
                  Réessayer
                </button>
              </div>
