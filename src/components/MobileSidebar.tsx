    ...
    <>
      ...
      {isMounted && isOpen && createPortal(
        <>
          ...
          <nav
            ref={sidebarRef}
            className={`fixed top-0 start-0 bottom-0 bg-black/95 backdrop-blur-xl border-e border-white/10 lg:hidden transition-transform duration-300 ease-in-out translate-x-0`}
            style={{
          ...
          >
            <div className="p-4 pb-8">
              ...
              <button
                ...
                className="absolute top-4 end-4 p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-all"
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="ms-auto w-2 h-2 bg-purple-400 rounded-full"></div>
                </Link>
                ...
                {user && (
                  <Link 
                    ...
                    style={{ WebkitTapHighlightColor: 'transparent' }}
                  >
                    <Grid className="w-5 h-5 me-4" />
                    <span className="font-medium">{t('myListings')}</span>
                    {userListingsCount > 0 && (
                      <div className="ms-auto bg-blue-500 text-white text-xs px-2 py-1 rounded-full font-medium">
                        {userListingsCount}
                      </div>
                    )}
                  </Link>
                ...
                <Link 
                  ...
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
                  <Plus className="w-5 h-5 me-4" />
                  <span className="font-medium">{t('post')}</span>
                  <div className="ms-auto bg-gradient-to-r from-orange-400 to-red-500 text-white text-xs px-2 py-1 rounded-full font-bold">NEW</div>
                </Link>
                ...
                <Link 
                  ...
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
                  <Heart className="w-5 h-5 me-4" />
                  <span className="font-medium">{t('favorites')}</span>
                  {userFavoritesCount > 0 && (
                    <div className="ms-auto bg-red-500 text-white text-xs w-6 h-6 rounded-full flex items-center justify-center">
                      {userFavoritesCount}
                    </div>
                  )}
                </Link>
                ...
                <Link 
                  ...
                  style={{ WebkitTapHighlightColor: 'transparent' }}
                >
                  <MessageCircle className="w-5 h-5 me-4" />
                  <span className="font-medium">{t('messages')}</span>
                  <div className="ms-auto flex items-center">
                    <div className="bg-green-500 text-white text-xs px-2 py-1 rounded-full font-medium me-2">2</div>
                    ...
                    <>
                      ...
                      {showInstallButton && (
                        ...
                        >
                          ...
                          {deferredPrompt && (
                            <div className="ms-auto bg-gradient-to-r from-pink-400 to-purple-500 text-white text-xs px-2 py-1 rounded-full font-bold animate-pulse shadow-lg">
                              READY
                            </div>
                          )}
                        </button>
